...
podman run \
  ...
  -e APP_ARGS="--no-default-browser-check --no-first-run --start-maximized --load-extension=/opt/extensions/UserAgent" \
  -v /opt/jdgregson-browser-host/src/browser/extensions:/opt/extensions \
